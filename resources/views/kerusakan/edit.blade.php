...
@section('title', 'Edit Kerusakan - Sistem Pakar Motor')
    ...
    <header class="bg-gray-900/80 backdrop-blur-sm border-b border-gray-700 sticky top-0 z-10">
        <div class="px-8 py-6">
            <h1 class="text-3xl font-bold text-white">
                <i class="fas fa-edit text-green-400 mr-3"></i>Edit Kerusakan
            </h1>
            <p class="text-gray-400 mt-1">Edit data kerusakan: {{ $kerusakan->nama_kerusakan }}</p>
        </div>
    </header>
                ...
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <textarea name="solusi" rows="5"
                                  ...
                                  class="w-full bg-gray-800 border border-gray-700 rounded-lg px-4 py-3 text-white
                                         placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-green-500
                                         focus:border-green-500 transition resize-none">{{ old('solusi', $kerusakan->solusi) }}</textarea>
                        @error('solusi')
                            <p class="mt-2 text-red-400 text-sm">{{ $message }}</p>
                        @enderror
                    </div>
