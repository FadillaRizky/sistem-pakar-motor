...
@section('title', 'Tambah Gejala - Sistem Pakar Motor')
    ...
    <header class="bg-gray-900/80 backdrop-blur-sm border-b border-gray-700 sticky top-0 z-10">
        <div class="px-8 py-6">
            <h1 class="text-3xl font-bold text-white">
                <i class="fas fa-plus text-blue-400 mr-3"></i>Tambah Gejala Baru
            </h1>
            <p class="text-gray-400 mt-1">Tambahkan data gejala kerusakan motor</p>
        </div>
    </header>
                ...
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <textarea name="deskripsi" rows="4"
                                  ...
                                  class="w-full bg-gray-800 border border-gray-700 rounded-lg px-4 py-3 text-white
                                         placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-blue-500
                                         focus:border-blue-500 transition resize-none">{{ old('deskripsi') }}</textarea>
                        @error('deskripsi')
                            <p class="mt-2 text-red-400 text-sm">{{ $message }}</p>
                        @enderror
                    </div>
